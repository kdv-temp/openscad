...
highlight          = hsv_deg(75,70,90);
axes_color         = hsv_deg(330,70,90);
opencsg_face_front = hsv_deg(60,70,90);
opencsg_face_back  = hsv_deg(330,70,90);
cgal_face_front    = hsv_deg(60,70,90);
cgal_face_back     = hsv_deg(330,70,90);
cgal_face_2d       = hsv_deg(60,70,90);
cgal_edge_front    = hsv_deg(60,70,90);
cgal_edge_back     = hsv_deg(330,70,90);
cgal_edge_2d       = hsv_deg(330,70,90);
crosshair          = hsv_deg(75,70,90);
